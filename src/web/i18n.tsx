...
const english: Record<string, string> = {
  ...
  "最近 48 小时没有 Webhook 记录。": "No webhook records from the last 48 hours.",
  ...
  "正在发送…": "Sending…",
  "配置完整邮件投递，并检查最近 48 小时的每一次发送。":
    "Configure complete-message delivery and inspect every send from the last 48 hours.",
  "刷新记录": "Refresh records",
  "正在投递": "Delivering",
  "已停用": "Disabled",
  "完整邮件投递": "Complete-message delivery",
  "一次 HTTPS POST 包含 payload JSON 和原始 EML；签名密钥不会出现在记录中。":
    "Each HTTPS POST contains payload JSON and the raw EML. Signing secrets never appear in records.",
  "签名密钥": "Signing key",
  "未配置": "Not configured",
  "端点版本": "Endpoint revision",
  "Webhook 配置已保存。": "Webhook configuration saved.",
  "发送记录": "Send records",
  "记录到期后立即不可访问，并由维护任务彻底删除。":
    "Expired records become inaccessible immediately and are permanently removed by maintenance.",
  "记录类型": "Record type",
  "全部类型": "All types",
  "正式邮件": "Email",
  "合成测试": "Synthetic test",
  ...
  "已中断": "Interrupted",
  "正在加载发送记录…": "Loading send records…",
  "无主题邮件": "Untitled message",
  "最近没有发送记录": "No recent send records",
  "启用 Webhook 后，新邮件和合成测试会显示在这里。":
    "New messages and synthetic tests will appear here after Webhook is enabled.",
  "上一页": "Previous",
  "下一页": "Next",
  "选择一条记录": "Select a record",
  "查看发送目标、请求内容和接收端响应。":
    "Inspect the destination, request content, and receiver response.",
  "正在加载记录详情…": "Loading record details…",
  "发送详情": "Send details",
  "发送目标": "Destination",
  "发送时间": "Sent at",
  "状态码": "Status code",
  ...
  "Webhook 发送记录不存在。": "The webhook send record does not exist.",
  "Webhook 发送记录已过期。": "The webhook send record has expired.",
  "Webhook 请求内容不可用。": "The webhook request content is unavailable.",
  "Webhook 响应内容不可用。": "The webhook response content is unavailable.",
  "Webhook 记录结果筛选无效。": "The webhook record result filter is invalid.",
  "Webhook 记录类型筛选无效。": "The webhook record type filter is invalid.",
